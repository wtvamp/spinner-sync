...
const BANGS_MASC = ['messyspiky.png','shortdisheveled.png','shortslightmess.png','shortneat.png','widowspeak.png'];
...
async function generateAvatar() {
  ...
  // 3. Facial features (detail stamps on top of face)
