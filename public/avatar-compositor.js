    ...
    for (let y = 0; y < 64; y++) {
      for (let x = 0; x < 64; x++) {
        ...
        if (HAIR_SET.has(hk)) {
          ...
          const makeHair = density >= 12; // need 12+ hair pixels in 7x7 area (tight boundary)
